...
## 实验信息
- **开始时间**: Sat Jun 14 12:20:27 AM CST 2025
- **实验名称**: v3-LR6e-6-R16-20250614-002022
...
- `main.py`: Python主训练脚本  
- `training_config_20250614-002022.txt`: 详细训练参数
- `full_command_20250614-002022.txt`: 完整执行命令
- `experiment_info_20250614-002022.md`: 本实验说明文件

**注意**: 所有训练脚本已自动备份到与模型权重相同的目录中，便于追溯和复现实验。

## 监控链接
- **WandB项目**: https://wandb.ai/qhy0227-tsinghua-university/VerilogGRPO_Enhanced_8B
- **运行页面**: https://wandb.ai/qhy0227-tsinghua-university/VerilogGRPO_Enhanced_8B/runs/v3-LR6e-6-R16-20250614-002022
